...
zip func.zip func.py > /dev/null

echo "> Creating lambda function..."
aws lambda create-function --function-name $lambda_name --zip-file fileb://func.zip --handler func.handler --runtime python3.9 --role $arn > /dev/null
